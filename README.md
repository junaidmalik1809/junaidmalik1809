...
* **Cybersecurity & Network Security:** Threat Detection, Malware Analysis, Traffic Analysis, Brute Force Mitigation, IDS/IPS, Security Monitoring
* **Networking:** TCP/IP, DNS, DHCP, Subnetting, VPN, OSI Model, Network Troubleshooting
* **Security Tools:** Wireshark, Nmap, Snort, pfSense, Hydra
* **Systems & Virtualization:** Windows 10/11 Troubleshooting, VirtualBox, VMware
* **Other Skills:** IT Support, Hardware Troubleshooting, Incident Reporting, Access Control

---

## 💻 Highlighted Security Projects

### 🛡️ Brute Force Detection Lab — Network Security Project
...
MSc Cyber Security & Digital Forensics final year project exploring machine learning approaches for malware detection and analysis.
